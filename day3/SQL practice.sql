...
select employee_id, first_name, salary, salary*12 + (salary*12*commission_pct)
from employees;
...
select employee_id, first_name, salary , salary*0.15 risen ,salary - (salary * 0.15) difference
from employees
...
select employee_id, first_name, hire_date, trunc((sysdate - hire_date)/12) workingmonths
from employees;
...
-- 101 김유신 15000 ***************
-- 102 강감찬 7300  *******
select employee_id, first_name, salary, rpad (salary,3, '*')
from employees;
